...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar" style="background-color :whitesmoke">
    <div class="profile-sidebar">
        <div class="profile-userpic">
            <img src="img/orang.JFIF" class="img-responsive" alt="">
        </div>
    ...
    <?php 
        if (isset($_GET['dashboard'])){ ?>
            <li class="active">
                <a href="index.php?dashboard"><em class="fa fa-bar-chart-o">&nbsp;</em>
                    Dashboard
                </a>
            </li>
        <?php } else{?>
